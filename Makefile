...
triangles: main double_intersect intersect point plane line vector triangle double_numbers octotree
	g++ obj/main.o obj/double_intersect.o obj/intersect.o obj/point.o obj/plane.o obj/line.o obj/vector.o obj/triangle.o obj/double_numbers.o obj/octree.o $(OPT_FLAGS) -o triangles

main:
	g++ -c ./main.cpp $(OPT_FLAGS) -o obj/main.o

double_intersect:
	g++ -c ./Intersection/double_intersection.cpp $(OPT_FLAGS) -o obj/double_intersect.o
